...
const coreMandatoryMenuOptions: readonly MandatoryMenuOption[] = [
  {
    id: "dashboard",
    label: "Dashboard",
    groups: [
...
const additionalMandatoryMenuOptions: readonly MandatoryMenuOption[] =
  hospitalModuleLabels.map((label) => {
    const menuId = label.toLowerCase().replaceAll(" ", "-");
      ...
      groups: [
        {
          ...
          label,
          fields: [
            { id: `${menuId}-reference`, label: "Reference Number" },
            { id: `${menuId}-date`, label: "Date" },
            { id: `${menuId}-status`, label: "Status" },
            { id: `${menuId}-notes`, label: "Notes" },
          ],
        },
      ],
    };
...
export const mandatoryMenuOptions: readonly MandatoryMenuOption[] = [
  ...coreMandatoryMenuOptions,
  ...additionalMandatoryMenuOptions,
];
